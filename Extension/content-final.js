...
function onPost() {
  ...
  chrome.runtime.sendMessage({type:'event_create', title: eventname, desc: description, cron: mytimecron, date: date, priority: "low_priority"}, function() {
...
//   var send_button = getElementByXpath("/html/body/div[1]/div/div/div[2]/span/div[2]/div[2]/div[2]/div[2]/a")
//   var possibility_one = getElementByXpath("/html/body/div[1]/div/div/div[2]/span/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div[1]/div/div/div/div/div/div/span")
//   var possibility_two = getElementByXpath("/html/body/div[1]/div/div/div[2]/span/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div[1]/div/div[2]/div/div/div/div/span")
//   console.log("P1: " + possibility_one)
//   console.log("P2: " + possibility_two)
//   var text_field = possibility_one
//   if(possibility_one==null || possibility_one==undefined){
//     text_field = possibility_two
//   }
//     // var msg_span = document.createElement("span");
//   // msg_span.setAttribute("data-text", "true")
//   // msg_span.innerHTML = "This is my message"
//   var text = "gang gangggg"
//   var msg = "<span data-text='true'>" + text + "</span>"
//   // while (text_field.firstChild) {
//   //   text_field.removeChild(text_field.firstChild);
//   // }
//   // text_field.appendChild(msg_span)
//   // text_field.innerHTML = msg
...
function insertButton(){
    ...
    // var element = getElementByXpath("/html/body/div[1]/div[1]/div[1]/div/div/div/div[2]/span/div[2]/div[1]/div/div/div[1]/div/div/div/div[2]/div[2]/span")
...
chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
    if(request.type==="switchTab"){
        ...
        if(request.message != null && obj != null && obj.reminders != null){
...
function destroyPickers(){
  ...
  if (date_picker_elem != null){
    var picker = M.Datepicker.getInstance(date_picker_elem);
  ...
  if (time_picker_elem != null){
    var picker = M.Timepicker.getInstance(time_picker_elem);
    if (picker != null && picker != undefined){
      picker.destroy()
    } 
  }

  // if(dateinstance != undefined && timeinstance != undefined && dateinstance != null && timeinstance != null){
...
function openModal() {
  // var text_field = getElementByXpath("/html/body/div[1]/div/div/div[2]/span/div[2]/div[2]/div[2]/div[2]/div[2]/div/div/div[1]/div/div/div/div/div/div/span")
...
function editReminder(element){
  ...
  document.getElementById("datepicker").value = results[0];
  document.getElementById("timepicker").value = results[1];
...
function convertDateToPickers(d){
  var date = d.split(",")[0]
  var time = d.split(",")[1]
  portions = date.split(" ")
  second_portion = portions[1]
  second_portion = second_portion.replace("st", "")
  second_portion = second_portion.replace("th", "")
  second_portion = second_portion.replace("rd", "")
  second_portion = second_portion.replace("nd", "")

  date = portions[0] + " " + second_portion + " " + portions[2]
...
function injectOneReminder(reminder){
  ...
  var dateText = moment(date).format('MMMM Do YYYY, h:mm a');
...
},{"materialize-css":2,"moment":3}],2:[function(require,module,exports){
(function (global){
/*!
